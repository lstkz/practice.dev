  ...
  return (
    <Dashboard>
      <Container data-test="privacy-page">
        ...
        <Box full>
          <p>
            Your privacy is important to us. It is PracticeDev's policy to
            respect your privacy regarding any information we may collect from
            you across our website,{' '}
            <a href="https://practice.dev">https://practice.dev</a>, and other
          ...
          <p>
            ...
            personal information on our website, and you have not received a
          ...
          <p>
            This privacy policy only covers PracticeDev's own collecting and
          ...
          <p>
            <strong>PracticeDev Data Controller</strong>
            <br />
            Contact
            <br />
            contact@practice.dev
          </p>
          <p>This policy is effective as of July 1, 2020.</p>
        </Box>
      </Container>
    </Dashboard>
  );
