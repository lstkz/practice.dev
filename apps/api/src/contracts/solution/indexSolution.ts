...
// import { esPutItem } from '../../common/elastic';
...
//       t.insert(item);
//     });
//     await esPutItem('solution', solution.solutionId, solution.getProps());
//     await t.commit({
...
//     });
//     await esPutItem('solution', newSolution.solutionId, newSolution.getProps());
//     await t.commit({
//       ignoreTransactionCanceled: true,
//     });
//   });
